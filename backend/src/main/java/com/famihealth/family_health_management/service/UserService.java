...
public interface UserService {
	...
	PageResponse<UserSummaryDto> getAll(String field, String keyword, Boolean locked, Pageable pageable);

	PageResponse<UserSummaryDto> getByKeyword(String field, String keyword, Boolean locked, Pageable pageable);
}
